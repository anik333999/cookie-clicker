...
//standard building upgrades
	...
	new G.Upgrade({
		...
		id:323,
		desc:`Allows you to purchase a <b>crumbly egg</b> once you have earned 1 million cookies.`,
	...
	new G.Upgrade({
		name:`Dragon scale`,
		id:648,
		desc:`Cookie production multiplier <b>+3%</b>.<br>Cost scales with CpS, but 10 times cheaper with a fully-trained dragon.`,
		q:`Your dragon sheds these regularly, so this one probably won't be missed.<br>Note: icon not to scale.`,
		icon:[30,14],
		order:25100.648,
		cost:999,
		pool:'',
		costFunc:(me)=>{return G.cookiesPsUnbuffed*60*30*((G.dragonLevel<G.dragonLevels.length-1)?1:0.1);},
		effs:[['cpsM',1.03,1]],
	});
	...
	new G.Upgrade({
		name:`Dragon claw`,
		id:649,
		desc:`Clicking is <b>3%</b> more powerful.<br>Cost scales with CpS, but 10 times cheaper with a fully-trained dragon.`,
		q:`Will grow back in a few days' time.<br>A six-inch retractable claw, like a razor, from the middle toe. So you know, try to show a little respect.`,
		icon:[31,14],
		order:25100.649,
		cost:999,
		pool:'',
	...
	new G.Upgrade({
		name:`Dragon fang`,
		id:650,
		desc:`Golden cookies give <b>3%</b> more cookies.<br>Dragon harvest and Dragonflight are <b>10% stronger</b>.<br>Cost scales with CpS, but 10 times cheaper with a fully-trained dragon.`,
		q:`Just a fallen baby tooth your dragon wanted you to have, as a gift.<br>It might be smaller than an adult tooth, but it's still frighteningly sharp - and displays some awe-inspiring cavities, which you might expect from a creature made out of sweets.`,
		icon:[30,15],
		order:25100.65,
		cost:999,
		pool:'',
		costFunc:(me)=>{return G.cookiesPsUnbuffed*60*30*((G.dragonLevel<G.dragonLevels.length-1)?1:0.1);},
		effs:[['gcEffectsMultM',1.03,1],['gcWrathEffectsMultM',1.03,1]],
	});
		
	new G.Upgrade({
		name:`Dragon teddy bear`,
		id:651,
		desc:`Random drops are <b>3% more common</b>.<br>Cost scales with CpS, but 10 times cheaper with a fully-trained dragon.`,
		q:`Your dragon used to sleep with this, but it's yours now.<br>Crafted in the likeliness of a fearsome beast. Stuffed with magical herbs picked long ago by a wandering wizard. Woven from elven yarn and a polyester blend.`,
		icon:[31,15],
		order:25100.651,
		cost:999,
		pool:'',
		costFunc:(me)=>{return G.cookiesPsUnbuffed*60*30*((G.dragonLevel<G.dragonLevels.length-1)?1:0.1);},
		effs:[['dropChanceM',1.03,1]],
	});
	...
	new G.Upgrade({
		name:`Fortune #102`,
		id:640,
		desc:`<b>+2%</b> cookie production from power click buffs. <small>(Must own the Power clicks upgrade.)</small>`,
	...
	new G.Upgrade({
		name:`Wrinkler ambergris`,
		id:875,
		desc:`Cookie production multiplier <b>+6%</b>.<br>All upgrades are <b>1% cheaper</b>.<br>Cost scales with CpS.`,
		q:`Occasionally regurgitated by wrinklers.<br>The byproduct of some obscure metabolic process or other, it is as rare and precious as it is pungent.<br>Makes for a great toast spread.`,
		icon:[31,36],
		order:25050.875,
		cost:60,
		pool:'',
		effs:[['cpsM',1.06,1],['upgradeCostM',0.99,1]],
		lasting:true,
		costFunc:(me)=>{return Math.max(1000000,G.cookiesPsUnbuffed*60*60);},
	});
	...
	new G.Upgrade({
		name:`Power clicks`,//`Twin Gates of Transcendence`,
		id:281,
		...
		q:`There's plenty of knowledgeable people up here, and you've been given some excellent pointers.`,
		icon:[30,36],//[15,11],
		order:281,
		cost:1,
		pool:'prestige',
	...
	for (let i=0;i<slots.length;i++)
	{
		...
		slot.preDescFunc=function()
		{
			...
			var icon=slot.icon;
			return G.button({text:`<div class="icon" style="vertical-align:middle;display:inline-block;background-position:`+(-icon[0]*48)+`px `+(-icon[1]*48)+`px;transform:scale(0.5);margin:-16px;margin-right:-8px;"></div>Assign upgrade`,classes:'fancy magicButton bumpButton',style:'padding:6px 16px;margin:2px 16px 6px 16px;display:block;font-size:14px;',onclick:function(){
				slotAssignPopup(i);
			}});
		}
	}
	...
	new G.Upgrade({
		name:`Golden switch`,
		id:327,
		desc:`Unlocks the <b>golden switch</b>, which passively boosts your CpS by 50% but disables golden cookies.`,
		q:`Less clicking, more idling.`,
		icon:[21,10],
		order:282.001,
		cost:999,
		pool:'prestige',
		parents:[`Heavenly luck`],
		func:(me)=>{G.unlock('Golden switch [off]');},
	});
	new G.Upgrade({
		name:`Golden switch [off]`,
		id:331,
		desc:`Turning this on will passively boost your CpS, but prevents golden cookies from spawning.<br>Cost is equal to 1 hour of production.`,
		q:``,
		icon:[20,10],
		order:40000.331,
		cost:1000000,
		pool:'toggle',
		costFunc:(me)=>{return G.cookiesPsUnbuffed*60*60;},
		func:(me)=>{
			G.toggleOff('Golden switch [off]');G.toggleOn('Golden switch [on]');
		},
		effs:[['cpsM',v=>{return v*(1+
			0.5
			+0.1*(G.Has('Residual luck')?G.goldenCookieUpgrades.filter(me=>me.owned).length:0)
		);},2]],
	});
	new G.Upgrade({
		name:`Golden switch [on]`,
		id:332,
		desc:`The switch is currently boosting your CpS; it also prevents golden cookies from spawning.<br>Turning it off will revert those effects.<br>Cost is equal to 1 hour of production.`,
		q:``,
		icon:[21,10],
		order:40000.332,
		cost:1000000,
		...
		costFunc:(me)=>{return G.cookiesPsUnbuffed*60*60;},
		func:(me)=>{
			G.toggleOff('Golden switch [on]');G.toggleOn('Golden switch [off]');
		},
	});
	...
	new G.Upgrade({
		name:`Residual luck`,
		id:365,
		desc:`While the golden switch is on, you gain an additional <b>+10% CpS</b> per golden cookie upgrade owned.`,
		q:`Fortune comes in many flavors.`,
		icon:[27,6],
		order:282.00199999999995,
		cost:99999,
		pool:'prestige',
	...
	new G.Upgrade({
		...
		id:397,
		desc:`Golden cookies (and all other things that spawn, such as reindeer) have <b>1% chance of being doubled</b>.`,
		q:`Tastes glittery. The empty phial makes for a great pencil holder.`,
		icon:[27,12],
		order:282.0049999999999,
		cost:7777777,
		pool:'prestige',
	...
	new G.Upgrade({
		name:`Kitten wages`,
		id:646,
		desc:`Through clever accounting, this actually makes kitten upgrades <b>10% cheaper</b>.`,
		q:`Cats can have little a salary, as a treat.<br>Cats are expert hagglers and have a keen sense of bargaining, especially in the case of cash.`,
		icon:[31,8],
		order:274.0049999999999,
		cost:9000000000,
		pool:'prestige',
		parents:[`Kitten angels`],
	});
	
	new G.Upgrade({
		name:`Five-finger discount`,
		id:368,
		desc:`All upgrades are <b>1% cheaper per 100 cursors</b>.`,
		q:`Stick it to the man.`,
		icon:[28,7],
		order:253.00300000000001,
		cost:555555,
		pool:'prestige',
		parents:[`Halo gloves`,`Abaddon`],
		effs:[['upgradeCostM',v=>{return v*Math.pow(0.99,G.buildings[0].amount/100);},2]],
	});
	
	new G.Upgrade({
		name:`Classic dairy selection`,
		id:328,
		desc:`Unlocks the <b>milk selector</b>, letting you pick which milk is displayed under your cookie.<br>Comes with a variety of basic flavors.`,
		q:`Don't have a cow, man.`,
		icon:[1,8],
		order:328,
		cost:9,
		pool:'prestige',
	...
	new G.Upgrade({
		...
		id:329,
		desc:`Contains more exotic flavors for your milk selector.`,
		q:`Strong bones for the skeleton army.`,
		icon:[9,7],
		order:328.001,
		cost:1000000,
		pool:'prestige',
	...
	new G.Upgrade({
		...
		id:362,
		desc:`Unlocks the <b>background selector</b>, letting you select the game's background.<br>Comes with a variety of basic flavors.`,
		q:`Prioritizing aesthetics over crucial utilitarian upgrades? Color me impressed.`,
		icon:[29,5],
		order:328.001,
		cost:99,
		pool:'prestige',
	...
	new G.Upgrade({
		name:`Distinguished wallpaper assortment`,
		id:804,
		desc:`Contains more wallpapers for your background selector.`,
		q:`Do you ever think about the physicality of this place? Are you putting up these wallpapers in your office or something? Where are you, anyway?`,
		icon:[27,5],
		order:328.00199999999995,
		cost:10000000,
		pool:'prestige',
	...
	new G.Achiev({
		...
		pool:'',
		unlockAt:{spe:v=>{
			if (G.season=='halloween' && G.GetHowManyHalloweenDrops()>=G.halloweenDrops.length) return true;
			return false;}},
	});
	...
	new G.Achiev({
		...
		pool:'',
		unlockAt:{spe:v=>{
			if (G.season=='christmas' && G.GetHowManyReindeerDrops()>=G.reindeerDrops.length) return true;
			return false;}},
	});
	...
	new G.Achiev({
		name:`Lovely cookies`,
		id:130,
		desc:`Own <b>every Valentine-themed cookie</b>.`,
		q:``,
		icon:[20,3],
		order:22300.13,
		pool:'',
